...
class Book(BaseModel):
    ...
    class Config:
        schema_extra = {
            "example": {
                "id": "19040829-5166-46ed-ab4d-321c548cd3c2",
...
async def negative_number_exception_handler(
    request: Request, excption: NegativeNumberException
):
    return JSONResponse(
        status_code=418,
        content={
            "message": f"Hey, why do you want {excption.books_to_return} books? You need to read more",
        },
    )
...
def create_books_no_api():
    book_1 = Book(
        id="b9040829-5166-46ed-ab4d-321c548cd3c2",
        title="Title 1",
        author="Author 1",
    ...
    book_2 = Book(
        id="b9040829-5266-46ed-ab4d-322c548cd3c2",
        title="Title 2",
        author="Author 2",
    ...
    book_3 = Book(
        id="b9040829-5366-46ed-ab4d-323c548cd3c2",
        title="Title 3",
        author="Author 3",
    ...
    book_4 = Book(
        id="b9040829-5466-46ed-ab4d-324c548cd3c2",
        title="Title 4",
        author="Author 4",
